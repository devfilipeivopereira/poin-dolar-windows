...
- `Grafico`: candles diarios, semanais ou mensais quando possivel, com pan horizontal e vertical, zoom de candles, espacamento horizontal configuravel entre candles, eixo de preco mais denso no zoom, linhas de preco configuraveis a cada 5, 10, 50 ou 100 ticks e linhas horizontais de niveis.
